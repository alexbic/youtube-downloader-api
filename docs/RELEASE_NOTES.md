...
Первый публичный релиз YouTube Downloader API - простого и надежного сервиса для скачивания видео с YouTube через REST API.

**Ключевые особенности:**
- ✅ Асинхронная и синхронная загрузка видео
- ✅ Встроенный Redis для хранения задач
